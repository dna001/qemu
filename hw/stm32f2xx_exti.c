...
void stm32f2xx_exti_set_gpio(Stm32Exti *s, unsigned exti_line, stm32_periph_t gpio)
{
    ...
    stm32f2xx_gpio_set_exti_irq(s->stm32_gpio[STM32_GPIO_INDEX_FROM_PERIPH(gpio)], exti_line, s->gpio_in_irqs[exti_line]);
}
...
void stm32f2xx_exti_reset_gpio(Stm32Exti *s, unsigned exti_line, stm32_periph_t gpio)
{
    ...
    stm32f2xx_gpio_set_exti_irq(s->stm32_gpio[STM32_GPIO_INDEX_FROM_PERIPH(gpio)], exti_line, NULL);
}
...
static Property stm32_exti_properties[] = {
    DEFINE_PROP_PTR("stm32f2xx_gpio", Stm32Exti, stm32_gpio_prop),
