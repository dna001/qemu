...
const char *stm32f2xx_periph_name(stm32_periph_t periph)
{
    ...
    return stm32f2xx_periph_name_arr[periph];
}
...
static Stm32Uart *stm32_create_uart_dev(
        ...
        qemu_irq irq)
{
    DeviceState *uart_dev = qdev_create(NULL, "stm32f2xx_uart");
            ...
            uint32_t osc32_freq)
{
    ...
    DeviceState *flash_dev = qdev_create(NULL, "stm32f2xx_flash");
    ...
    DeviceState *exti_dev = qdev_create(NULL, "stm32f2xx_exti");
    qdev_prop_set_ptr(exti_dev, "stm32f2xx_gpio", gpio_dev);
